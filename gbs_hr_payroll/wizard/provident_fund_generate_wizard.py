...
class ProvidentFundWizard(models.TransientModel):
    ...
    _description = 'Provident Fund Wizard'
    ...
    def process_print(self):
        ...
        data['employee_device_id'] = self.employee_id.employee_device_id
        # data['total_pf'] = self.employee_id.total_pf

        return self.env.ref('gbs_hr_payroll.action_individual_provident_fund').report_action(None, data=data)
