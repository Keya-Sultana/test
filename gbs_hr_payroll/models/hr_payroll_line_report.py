...
class HrPayrollLineReport(models.Model):
    _name = "hr.payroll.line.report"
    _description = "Payroll Line Analysis Report"
    _auto = False
    _rec_name = 'date_from'
...
class HrPayslipRun(models.Model):
    ...
    def action_open_payslips_line(self):
        self.ensure_one()
        return {
            "type": "ir.actions.act_window",
            "res_model": "hr.payroll.line.report",
            "views": [[False, "pivot"]],
            "name": "Payslips Line",
        }