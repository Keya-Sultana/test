...
class HrLeave(models.Model):
    ...
    def _check_date(self):
        for holiday in self:
            ...
            if holiday.date_from >= datetime.datetime.combine(holiday.leave_year_id.date_start, datetime.time(0, 0)) \
                    and holiday.date_to <= datetime.datetime.combine(holiday.leave_year_id.date_end, datetime.time(23, 59, 59)):
                pass
            else:
