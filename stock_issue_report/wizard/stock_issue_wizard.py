...
class StockIssueWizard(models.Model):
    _name = 'stock.issue.wizard'
    _description = "Stock Issue Wizard"
    ...
    def process_report(self):
        ...
        return self.env.ref('stock_issue_report.action_stock_issue_report').report_action(None, data=data)
