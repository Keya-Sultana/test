...
class HrShiftEmployeeBatch(models.Model):
    ...
    def generate_emp_att_slot(self, working_schedule, start_date, end_date, employee):
        ...
        slot_ids = self.env['planning.slot'].search(
            [('employee_id', '=', employee.id), ('start_datetime', '>=', start_date),
        ...
        for i in range(int((end_date - start_date).days) + 1):
            ...
            for wk_schedule_line in working_schedule.attendance_ids:
                if wk_schedule_line.dayofweek == str(dt.weekday()):
                    ...
                    vals = {'employee_id': employee.id or False,
                            'role_id': employee.default_planning_role_id.id or False,
