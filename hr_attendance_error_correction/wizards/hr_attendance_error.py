...
class AttendanceErrorCorrection(models.TransientModel):
    ...
    def search_data(self):
        ...
        view = self.env.ref('hr_attendance_error_correction.hr_attendance_error_tree')
        ...
        if (self.type == 'employee_type'):
            ...
            emp_ids = employee_pool.search([('default_operating_unit_id', '=', self.operating_unit_id.id), ('is_monitor_attendance', '=', True)])
