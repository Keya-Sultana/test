...
class PayrollReportPivotal(models.AbstractModel):
    _name = 'report.hr_payroll_top_sheet.report_top_sheet'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        inword = {
            ...
            'bnet_word': top_sheet.company_id.currency_id.amount_to_text(bnet),
            'net_word': top_sheet.company_id.currency_id.amount_to_text(net),
            'cash_word': top_sheet.company_id.currency_id.amount_to_text(net - bnet),
