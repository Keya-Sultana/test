...
class AttendanceErrorCorrection(models.TransientModel):
    ...
    def search_data(self):
        ...
        if (self.type == 'employee_type'):
            ...
            emp_ids = employee_pool.search(
                [('department_id', '=', self.department_id.id), ('is_monitor_attendance', '=', True)])
        elif (self.type == 'op_type'):
            emp_ids = employee_pool.search(
                [('operating_unit_id', '=', self.operating_unit_id.id), ('is_monitor_attendance', '=', True)])
