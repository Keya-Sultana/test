...
class InheritCurrencyRate(models.Model):
    ...
    # reverse_rate = fields.Float(string='Rate', digits=(12, 8), default=1.0)  default=1.0 add korla create kora jayna
    reverse_rate = fields.Float(string='Rate', digits=(12, 8))
