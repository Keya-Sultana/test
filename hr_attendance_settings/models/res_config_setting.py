...
class HRAttendanceConfigSettings(models.TransientModel):
    ...
    skip_unmapped_emp_code = fields.Boolean(string='Skip Unmapped Employee Code', config_parameter='hr_attendance_settings.skip_unmapped_emp_code')
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('hr_attendance_settings.server_url',
                                                         self.server_url)
        self.env['ir.config_parameter'].sudo().set_param('hr_attendance_settings.skip_unmapped_emp_code',
                                                         self.skip_unmapped_emp_code)
