...
class PurchaseRequisition(models.Model):
    ...
    def action_done(self):
        if self.sudo().env.user.has_group('purchase.group_purchase_manager'):
...
class PurchaseRequisitionLine(models.Model):
    ...
    product_qty = fields.Float(string='Quantity', digits='Product Unit of Measure', compute='_get_product_quantity')
