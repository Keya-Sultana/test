...
class ComparativeBidReport(models.AbstractModel):
    _name = 'report.purchase_rfq_comparison.com_bid_report_temp'
    ...
    def _get_report_values(self, docids, data):
        ...
        # return self.env['report'].render('purchase_rfq_comparison.com_bid_report_temp', docargs)
    ...
    def get_rfq_data(self, rfq_obj):
        ...
        rfq_data['rfq_date'] = str(rfq_obj.rfq_date)
