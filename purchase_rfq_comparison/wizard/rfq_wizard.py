...
class RFQWizard(models.TransientModel):
    ...
    def print_rfq(self):
        ...
        return self.env.ref('purchase_rfq_comparison.action_rfq_report').report_action(None, data=data)
    ...
    def action_save_rfq(self):
        ...
        rfq_name = self.env['ir.sequence'].next_by_code('purchase.rfq', date.today()) or '/'
        ...
        view_id = self.env.ref('purchase_rfq_comparison.view_purchase_rfq_form')
