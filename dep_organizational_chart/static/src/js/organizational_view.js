odoo.define('dep_organizational_chart.view_chart', function (require){
"use strict";
...
var DepartmentOrganizationalChart =  AbstractAction.extend({

    contentTemplate: 'OrganizationalDepartmentChart',
//    events: {
...
//    },
    ...
    renderDepartmentDetails: function (){
        var employee_id = 1
        var self = this;
        console.log("hhhhh",this)
        this._rpc({
            route: '/get/parent/department',
        }).then(function (result) {
            self.parent_len = result[1];
            $.ajax({
                url: '/get/parent/childs',
                type: 'POST',
                data: JSON.stringify(result[0]),
                success: function (value) {
                        $('#o_parent_department').append(value);
                        },
            });
...
//    },
    ...
    core.action_registry.add('dep_organization_dashboard', DepartmentOrganizationalChart);
