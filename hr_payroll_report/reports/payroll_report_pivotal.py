...
class PayrollReportPivotal(models.AbstractModel):
    _name = 'report.hr_payroll_report.report_individual_payslip'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        data = {}
        data['name'] = payslips.name
        # data['type'] = payslips.type
                ...
                if report_type == 'cash':
                    if not slip.employee_id.bank_account_id.id:
                        if d.id == slip.employee_id.department_id.id:
                            ...
                            gross = math.ceil((slip.employee_id.employee_contract_id.wage) * 2.5)
        ...
        for other_slip in payslips.slip_ids:
