...
class HrAttendanceErrorSummaryReport(models.AbstractModel):
    ...
    _description = 'Hr Attendance Error Summary Report'
    ...
    def _get_report_values(self, docids, data):
        ...
        if data['type'] == "unit_type":
            ...
            for dept in deptList:
                dpt_wise_emp = {'name': dept[1], 'seq': dept[2], 'val': []}
        ...
        ###### Department Wise
            ...
            dpt_wise_emp = {'name': data['department_name'], 'seq': 0, 'val': []}
    ...
    def getErrorAtt(self, emp, fromDate, toDate, att_utility_pool):
        ...
        attendance_list = []
        if not emp.is_monitor_attendance:
    ...
    def buildManagementEmployee(self, emp, attendanceList):
        ...
        if attendanceList[0][0] is not None and attendanceList[len(attendanceList) - 1][1] is not None:
            return emp_obj
    ...
    def buildNonManagementEmployee(self, emp, attendance):
        emp_obj = {'name': emp.name,
                   'acc_no': emp.device_employee_acc,
                   'designation': emp.job_id.name,
                   'check_in': attendance[0],
                   'check_out': attendance[1]
                   }
