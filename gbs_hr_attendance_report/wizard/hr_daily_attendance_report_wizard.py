# from odoo.osv import osv, orm   v-15 a orm missing
...
class DailyAttendanceReport(models.TransientModel):
    ...
    def process_report(self):
        ...
        return self.env.ref('gbs_hr_attendance_report.custom_report_of_daily_attendance').report_action(None, data=data)
