...
class HrPublicHolidays(models.Model):
    ...
    def geneare_yearly_calendar(self):
        ...
        # start_date = self.year_id.date_start
        ...
        start_date = str(self.year_id.date_start).split('-')
        end_date = str(self.year_id.date_end).split('-')

        noOfDays = 1 + (date(year=int(end_date[0]), month=int(end_date[1]), day=int(end_date[2]))
                        - date(year=int(start_date[0]), month=int(start_date[1]), day=int(start_date[2]))).days
        curTime = time.mktime(date(year=int(start_date[0]), month=int(start_date[1]), day=int(start_date[2])).timetuple())
