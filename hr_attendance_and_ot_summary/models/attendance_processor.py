...
class AttendanceProcessor(models.Model):
    ...
    def get_summary_data(self, employeeId, summaryId, graceTime, operating_unit_id, att_utility_pool,
        ...
        if len(dutyTimeMap) != 0:  # Check Rostering data are centered or not
            ...
            while currDate <= endDate:
                ...
                if att_utility_pool.checkOnPersonalLeave(employee, currDate) is True:
    ...
    def checkConsecutiveAbsence(self, attSummaryLine):
        # Block by Matiar Rahman
        # Need to implement a config to execute the below code
    ...
    def checkOnHolidays(self, startDate, holidayMap, employee, att_utility_pool):
        ...
        if holidayMap and holidayMap.get(start_date, False):
        ...
        # if todayIsHoliday and not employee.is_monitor_attendance:
        #     return True
        # else:
