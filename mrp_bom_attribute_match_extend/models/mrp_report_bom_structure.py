...
class ReportBomStructure(models.AbstractModel):
    ...
    def _get_bom_lines(self, bom, bom_quantity, product, line_id, level):
        ...
        for line in bom.bom_line_ids:
            ...
            product = line.product_id or line.component_template_id
            price = product.uom_id._compute_price(line.product_id.with_company(company).standard_price, line.product_uom_id) * line_quantity
            ...
            components.append({
                ...
                'compo_name': line.component_template_id.name,
