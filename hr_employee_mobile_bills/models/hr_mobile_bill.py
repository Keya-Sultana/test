...
class HrMobileBill(models.Model):
    ...
    name = fields.Char(size=100, string="Name", required=True, tracking=True, states={'draft': [('invisible', False)],
                                                                                      'applied': [('readonly', True)],
                                                                                      'approved': [('readonly', True)]})
    bill_date = fields.Date('Date', required=True, tracking=True, states={'draft': [('invisible', False)],
                                                                          'applied': [('readonly', True)],
                                                                          'approved': [('readonly', True)]})
